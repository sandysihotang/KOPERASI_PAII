<template>
    <div class="container">
        <b-breadcrumb :items="itemsTransaksi"></b-breadcrumb>
        <b-container>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" v-model="form_transaksi_baru.tanggal"
                               placeholder="Tanggal"
                               disabled>
                    </div>
                    <div class="form-group">
    ...
    export default {
        ...
        methods: {
            ...
            deleteProduk(row) {
                this.$swal.fire({
                    title: 'Anda yakin?',
                    text: "Menghapus Produk dari Transaksi!",
                    type: 'warning',
