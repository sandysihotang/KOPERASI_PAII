    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <div class="mt-2">
                ...
                <input v-model="form.password" type="password" class="fadeIn second"
                       placeholder="Password Baru">
                <b-button variant="primary" v-show="!show" @click="lupaPassword">Kirim</b-button>
